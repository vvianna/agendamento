...
describe('Service Tests', () => {
    describe('PlanoDeSaude Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PlanoDeSaudeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/plano-de-saudes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PlanoDeSaude', () => {
                service.create(new PlanoDeSaude(null)).subscribe(received => {
            ...
            it('should update a PlanoDeSaude', () => {
                service.update(new PlanoDeSaude(123)).subscribe(received => {
            ...
            it('should return a PlanoDeSaude', () => {
            ...
            it('should return a list of PlanoDeSaude', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PlanoDeSaude(123)]);
            });
