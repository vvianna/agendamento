    ...
    describe('Medico Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/medicos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Medico', () => {
                service.create(new Medico(null)).subscribe(received => {
            ...
            it('should update a Medico', () => {
                service.update(new Medico(123)).subscribe(received => {
