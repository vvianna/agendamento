...
describe('Service Tests', () => {
    describe('Especialidade Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EspecialidadeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/especialidades';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Especialidade', () => {
                service.create(new Especialidade(null)).subscribe(received => {
            ...
            it('should update a Especialidade', () => {
                service.update(new Especialidade(123)).subscribe(received => {
            ...
            it('should return a Especialidade', () => {
            ...
            it('should return a list of Especialidade', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Especialidade(123)]);
            });
