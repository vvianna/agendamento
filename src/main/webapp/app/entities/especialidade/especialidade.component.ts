...
export class EspecialidadeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.especialidadeService
            ...
            .subscribe(
                (res: HttpResponse<IEspecialidade[]>) => this.paginateEspecialidades(res.body, res.headers),
    ...
    private paginateEspecialidades(data: IEspecialidade[], headers: HttpHeaders) {
